...
export default () => (
    <PortfolioItemPage
        ...
        link="http://sushi-burger.ru/"
        image="https://pp.userapi.com/c847017/v847017448/e189b/loO1N2IOwvo.jpg"
    >
        <h2>Об этом проекте</h2>
        <hr/>
        <p>Данный сайт я разработал с командой в компании интернет-маркетинга "Интернет решения".</p>
